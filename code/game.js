...
var gravity = 15;   //original: 30
var jumpSpeed = 10; //original: 17
var playerYSpeed = 7;
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  if (obstacle == "lava"){
    //this.pos = new Player(new Vector(10,10));
   // this.player = newPos (new Vector(10,10));
   //var myVector1 = new Player (new Vector(10,10));
   //return myVector1;
   //var myVector1 = (10,10);
   //var myVector2 = this.pos.plus(myVector1)
   var deathsound = new Audio('kastenfrosch_passagierabsetzen.mp3')
   deathsound.play()
